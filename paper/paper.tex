...
and the bridge connecting the correction formula to the concrete Gotoh~DP
computation.
Both are verified exhaustively by testing
(174{,}000 and 17 cases respectively with zero failures)
but their full formal proofs require novel techniques for
relating global comb state to windowed DP simultaneously.
